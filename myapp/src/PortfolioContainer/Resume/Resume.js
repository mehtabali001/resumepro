...
const resumeDetails = [
    <div className='resume-screen-container' key="education">
        <ResumeHeading
        heading={"University of Kohat Science and Technology"}
        subHeading={"Bachelor Of Science Information Technology (Pakistan)"}
        fromDate={"2006"}
        toDate={"2010"}
        />
        <ResumeHeading
        heading={"College School"}
        subHeading={"Pre-Engineering From Al-Asar Academy Usterzai Payan Kohat (Pakistan)"}
        fromDate={"2004"}
        toDate={"2006"}
        />
        <ResumeHeading
    ...
    <ResumeHeading
    heading={"MK-TechSol Private Limited"}
    ...
    <ResumeHeading
    heading={"Haward Technology Middle East"}
...
const getBullets = () =>{
    return resumeBullets.map((bullet, index)=>(
        ...
        src={require(`../../Materials/Resume/${bullet.logoSrc}`)}
        alt=''
        />
